		...
		<form method="post" class="panel-body" id="gm_support_form">
			...
			<div class="container-fluid">
				<div class="form-header clearfix">
					<div class="alignleft">
						<img src="<?php echo esc_url( plugins_url( '/grand-media/admin/assets/img/icon-128x128.png' ) ); ?>" alt="" style="width:94px; height:94px;">
					</div>
								...
								<div class="dynamic">
									...
									<fieldset class="site">
										...
										<div class="form-group has-feedback">
											...
											<input type="text" name="link" class="form-control" value="<?php echo esc_attr( $link ); ?>" placeholder="<?php printf( __( 'Relevant Page on Your Site (E.g. %s)', 'grand-media' ), home_url( '/relevant-page/' ) ); ?>">
											<span class="glyphicon glyphicon-globe form-control-feedback"></span>
										</div>
									</fieldset>
