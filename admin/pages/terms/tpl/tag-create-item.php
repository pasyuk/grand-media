...
?>
<form method="post" id="gmedia-edit-term" name="gmAddTerms" class="panel-body" action="<?php echo esc_url( add_query_arg( [ 'term' => 'gmedia_tag' ], $gmedia_url ) ); ?>" style="padding-bottom:0; border-bottom:1px solid #ddd;">
	<div class="row">
