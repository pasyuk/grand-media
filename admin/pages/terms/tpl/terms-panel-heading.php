...
<div class="panel-heading clearfix" style="padding-bottom:2px;">
	...
	<div class="btn-toolbar pull-left" style="margin-bottom:7px;">
		...
		<?php if ( ! empty( $gmedia_terms ) ) { ?>
			...
			?>
			<form class="btn-group" id="gm-selected-btn" name="gm-selected-form" action="<?php echo esc_url( add_query_arg( [ 'term' => $gmedia_term_taxonomy, 'filter' => $filter_selected_arg ], $gmedia_url ) ); ?>" method="post">
				...
				<ul class="dropdown-menu" role="menu">
                    ...
                    <li class="<?php echo gm_user_can('gallery_manage')? '' : 'disabled'; ?>">
                        <a href="#libModal" data-modal="quick_gallery" data-action="gmedia_get_modal" data-ckey="<?php echo esc_attr( GmediaProcessor_Terms::$cookie_key ); ?>" class="gmedia-modal"><?php _e('Quick Gallery from Selected', 'grand-media'); ?></a>
                    </li>
                    <?php */ ?>
				</ul>
			</form>
