...
$referer = remove_query_arg( [ 'edit_term' ], $refurl );
?>
		...
		<?php if ( $term_id ) { ?>
			<div class="btn-group">
				...
				<ul class="dropdown-menu" role="menu">
					...
					<li><a href="<?php echo esc_url( add_query_arg( [ 'page' => 'GrandMedia', $taxkey => $term->term_id ], $gmProcessor->url ) ); ?>"><?php _e( 'Show in Gmedia Library', 'grand-media' ); ?></a></li>
					<?php
			...
			<div class="btn-group" style="margin-left:20px;">
				...
				if ( gm_user_can( 'upload' ) && ! $gmProcessor->gmediablank ) {
					...
					?>
					<a href="<?php echo esc_url( gm_get_admin_url( $args, [], true ) ); ?>" class="btn btn-success pull-left">
			...
			<div class="term-shortcode pull-left"><input type="text" title="<?php _e( 'Shortcode' ); ?>" class="form-control pull-left" value="<?php echo esc_attr( "[gm {$taxterm}={$term_id}]" ); ?>" readonly/>
