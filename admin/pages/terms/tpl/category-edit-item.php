	...
	<div class="row">
		<div class="col-xs-6">
			...
			<div class="form-group">
				...
				<?php
				wp_editor( esc_textarea( $term->description ), "category{$term->term_id}_description", [
				...
				<div class="col-xs-6">
					...
					<div class="form-group">
						...
						<div class="input-group">
							...
							<span class="input-group-btn"><a href="<?php echo esc_url( $gmCore->get_admin_url( [ 'page' => 'GrandMedia', 'mode' => 'select_single', 'gmediablank' => 'library', 'filter' => 'image' ], [], true ) ); ?>" class="btn btn-sm btn-primary preview-modal" data-target="#previewModal" data-width="1200" data-height="500" data-cls="select_gmedia_image" title="<?php _e( 'Choose Cover Image', 'grand-media' ); ?>"><span class="glyphicon glyphicon-picture"></span></a></span>
						</div>
					</div>
