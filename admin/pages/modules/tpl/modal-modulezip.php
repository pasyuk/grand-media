	...
	<div class="modal-dialog">
		<form class="modal-content" method="post" enctype="multipart/form-data" action="<?php echo esc_url( $gmedia_url ); ?>">
			<div class="modal-header">
				<h4 class="modal-title"><?php esc_html_e( 'Install a module in .zip format' , 'grand-media'); ?></h4>
				<button type="button" class="btn-close m-0" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body">
				<p class="install-help"><?php esc_html_e( 'If you have a module in a .zip format, you may install it by uploading it here.' , 'grand-media'); ?></p>
				<?php wp_nonce_field( 'gmedia_module', '_wpnonce_module' ); ?>
				<label class="screen-reader-text" for="modulezip"><?php esc_html_e( 'Module zip file' , 'grand-media'); ?></label>
