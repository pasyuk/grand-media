		...
		<header<?php echo ( $gmedia->description ) ? ' class="has-description"' : ''; ?>>
			<menu class="gmedia-menu">
				...
				<div class="gmedia-menu-items">
					<a href="<?php echo esc_url( $home_url ); ?>" class="btn btn-homepage" title="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>"><i class="fa fa-home"><span><?php _e( 'Home', 'grand-media' ) ?></span></i></a>
